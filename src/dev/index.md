...
### front-architecture
Los meta-frameworks de frontend según el objetivo del proyecto: Astro para sitios estáticos, React Router v7 e interactividad, TanStack Start para apps con mucho manejo de datos, Svelte por rendimiento, Next.js para SEO/e-commerce, Angular para proyectos enterprise/legacy.

### front-stack
Las piezas con las que se arma un frontend: routers (React Router, Wouter, TanStack Router) y librerías de componentes de UI (shadcn/ui, radix/ui, Mantine, HeadlessUI, HeroUI).
