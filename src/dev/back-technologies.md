...
Tres formas de que los servicios se hablen entre sí: **request-response** cuando alguien pregunta y espera respuesta, **mensajería** cuando no hace falta esperar, y **tiempo real** cuando el servidor necesita empujar datos al cliente.
